...
This step is optional but convenient for reproducibility and archiving.

---

You can now mirror this structure for the CN part in the README (same style:
step-by-step, mapping scripts to outputs and to the thesis tables/figures).
